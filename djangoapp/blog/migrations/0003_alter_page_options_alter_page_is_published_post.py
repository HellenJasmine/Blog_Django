...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='page',
            name='is_published',
            field=models.BooleanField(default=False, help_text='Este campo precisará estar marcado para a pagina ser exibida publicamente'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_in_post_content', models.BooleanField(default=True, help_text='exibir a imagem de capa tambem dentro do post?')),
